...
(function(global) {
	...
	let WordCloud = function WordCloud(elements, options) {
      ...
      var ngx; var ngy; // width and height of the grid
      var center; // position of the center of the cloud
      var maxRadius;
    ...
    function getInfoGridFromMouseTouchEvent(evt) {
       ...
       put it on the canvas. */
		let putWord = function putWord(item) {
			let word; var weight; var attributes;
		...
		let start = function start() {
         ...
         if not, update the grid to the current canvas state */
          ...
          canvas.getContext('2d').getImageData(0, 0, ngx * g, ngy * g).data;
			...
			i = 0;
			let loopingFunction; var stoppingFunction;
			if (settings.wait !== 0) {
